        ...
        <div className="container mb-5">
            <nav className="navbar navbar-expand-lg my-nav navbar-dark fixed-top">
                <div className="container">
                    <NavLink className="navbar-brand text-white" to="/home"><h3>Royal<span className="text-danger"> Academy</span></h3></NavLink>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-3 mb-lg-0">
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link  text-white" to="/notfound">More</NavLink>
                            </li>
